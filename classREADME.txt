...
* Inside your local git repository, create a directory for each Python Challenge. Use folder names corresponding to the challenges: **PyBank** and  **PyPoll**. DONE

* Inside of each folder that you just created, add the following: DONE

  * A new file called `main.py`. This will be the main script to run for each analysis. DONE
  * A "Resources" folder that contains the CSV files you used. Make sure your script has the correct path to the CSV file. DONE
  * An "analysis" folder that contains your text file that has the results from your analysis. DONE

* Push the above changes to GitHub or GitLab. DONE
